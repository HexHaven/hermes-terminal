...
function createDesktopUpdater(config) {
  ...
  async function run() {
    patch({ open: true, busy: false, offer: null, error: '', message: "This package uses Hermes updates. Run hermes plugins update hermes-terminal, then rescan Desktop plugins." });
  }
